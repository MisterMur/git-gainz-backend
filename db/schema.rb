...
ActiveRecord::Schema.define(version: 2019_12_19_125308) do
  ...
  create_table "userers", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_userers_on_email", unique: true
    t.index ["reset_password_token"], name: "index_userers_on_reset_password_token", unique: true
  end
